...
class JiraUserApp:
    ...
    def setup_ui(self):
        ...
        # Search bar
        search_frame = ttk.LabelFrame(data_tab, text="🔍 Search & Filters", padding=10)
        ...
        # Progress bar
        self.progress = ttk.Progressbar(data_tab, mode='indeterminate')
        ...
        footer_frame = ttk.Frame(data_tab)
...
"""
    ...
    def on_group_expand(self, _):
        ...
        if "group" not in self.tree.item(item, "tags"):
            return
